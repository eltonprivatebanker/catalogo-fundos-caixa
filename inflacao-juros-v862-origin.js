/* ============================================================
   V862 — Inflação e juros · legenda IPCA fixa com parâmetros da meta (desktop)
   ------------------------------------------------------------
   Objetivos:
   ...
   6) Não reescrever por JS a legenda fixa do IPCA: IPCA 12M / Meta 3,00% / Faixa 1,50%–4,50%.
   ============================================================ */
(() => {
  'use strict';
