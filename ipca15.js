/* IPCA-15 · PRODUÇÃO v720 */
(function ipca15ProducaoV720(){
  'use strict';

  const BUILD = 'ELTAUM_IPCA15_PROD_V720';
  ...
  async function carregar(){
    ...
    try{
      ...
      setStatus(false);
      console.info('[Catálogo CAIXA] IPCA-15 oficial carregado:', atual);
    }catch(err){
  ...
  window.__ELTAUM_IPCA15_PROD_V720__ = {
    build:BUILD,
    carregar,
    renderCalendar
  };
