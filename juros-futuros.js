/* =========================================================
   DI FUTURO · PRODUÇÃO v720
   Bloco limpo + integração visual nativa.
   ========================================================= */
(function jurosFuturosProducaoV720(){
  'use strict';
  ...
  window.__ELTAUM_DI_FUTURO_PROD_V720__ = {
    build:'ELTAUM_DI_FUTURO_PROD_V720',
    refresh(){
      const current = document.getElementById(CURRENT_ID);
  ...
  console.info('[Catálogo CAIXA] DI Futuro oficial v720 ativo');
})();
