/* ============================================================
   V861 — Inflação e juros · legenda IPCA fixa + semântica na origem (desktop)
   ------------------------------------------------------------
   Objetivos:
   ...
   6) Não reescrever por JS os três nomes fixos da legenda do IPCA.
   ============================================================ */
(() => {
  'use strict';
  ...
  /* V861: os três nomes da legenda são fixos por CSS; sem reescrita por JS. */
