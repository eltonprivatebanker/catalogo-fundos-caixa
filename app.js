...
(function(){
  ...
  const BUILD = 'ELTAUM_THEME_SWITCHER_20260609_v129';
...
(function(){
  try{
    ...
    if(boot) boot.remove();
    console.info('[Catálogo CAIXA] Sem tela inicial de carregamento: ELTAUM_THEME_SWITCHER_20260609_v129');
  }catch(e){}
})();
...
(function(){
  ...
  console.info('[Catálogo CAIXA] Init dados primeiro sem loop:', 'ELTAUM_THEME_SWITCHER_20260609_v129');
})();
...
(function(){
  ...
  function applyThemeV129(theme){
    ...
    if(toggle){
      const label = chosen === 'gold' ? 'Private Gold' : chosen === 'blue' ? 'Blue Corporate' : 'Light Professional';
