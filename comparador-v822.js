/* ============================================================
   V822 — COMPARADOR · CENTRALIZAÇÃO E SCROLL INICIAL
...
(function comparadorV822(){
  ...
  function wrapLegacyOpen(){
    if(typeof window.abrirComparador==='function' && !window.abrirComparador.__v820Wrapped){
      ...
      var wrapped=function(){
        ...
        portalOverlay();
        requestAnimationFrame(function(){portalOverlay();syncOpenState();resetHorizontalScrollV822(true);queueRefresh();});
        setTimeout(function(){portalOverlay();syncOpenState();resetHorizontalScrollV822(true);queueRefresh();},30);
        return result;
      };
  ...
  function init(){
    ...
    if(overlay.dataset.v822Bound==='1') return;
    overlay.dataset.v822Bound='1';
